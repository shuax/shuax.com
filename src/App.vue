<template>
    ...
    <main class="w-full">
        ...
        <section id="news" class="lg:min-h-screen section scroll-active-section bg-gradient-to-r from-sky-500 to-indigo-600">
            <Headline />
        </section>
        ...
        <section id="about" class="section scroll-active-section bg-gray-100">
            <About />
        </section>

        <section id="event" class="section scroll-active-section bg-gray-50">
            <Event />
        </section>
        ...
        <section id="contact" class="section scroll-active-section bg-gray-50">
            <Contact />
        </section>

        <section id="announcement" class="section scroll-active-section bg-gray-100">
            <Announcement />
        </section>
